...
function problemA() {
  ...
  // promise version
  // ???
  Promise.all([promisifiedReadFile('poem-two/stanza-01.txt'), promisifiedReadFile('poem-two/stanza-02.txt')]).then(poems => {
    poems.forEach(poem => blue(poem));
  }).then(() => console.log('-- A. callback version done --'));
